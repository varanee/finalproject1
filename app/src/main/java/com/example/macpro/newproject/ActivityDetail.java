...
public class ActivityDetail extends AppCompatActivity {
    ...
    private void showImgDialog(final CustomAdapter adapter) {
        /*ShowImgCircle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Activity7Detail.this);
    ...
    public void openDialog(String oldData, final int i) {
        final Dialog dialog = new Dialog(ActivityDetail.this);
        String title = "", Text = "";
        if (i == 1) {
        ...
        tvUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ProgressDialog progressDialog = new ProgressDialog(ActivityDetail.this);
