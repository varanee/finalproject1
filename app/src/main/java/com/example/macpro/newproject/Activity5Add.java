...
public class Activity5Add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity5_add2);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        final ImageView viewPhoto = findViewById(R.id.imageViewPhoto);
    ...
    public void openDialog() {
        ...
        final Dialog dialog = new Dialog(Activity5Add.this);
        ...
        tvUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                android.content.Intent i = new Intent(android.content.Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    private static File getOutputMediaFile() {
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "ProjectAndroid");
