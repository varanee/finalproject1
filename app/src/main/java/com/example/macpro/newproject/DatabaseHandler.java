    ...
    public List<Users> getAllUsers() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                databaseUser.child(String.valueOf(users._user_id)).setValue(users, new DatabaseReference.CompletionListener(){
                    @Override
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if (databaseError != null) {
                            String aa =  databaseError.getMessage();
                        } else {
                            String aa = "Data saved successfully.";
                        }
